...
export default function Footer() {
    return (
        <>
            <div className="container grid gap-10 px-4 py-10 md:grid-cols-2 sm:px-10">
            ...
            <div className="container block px-4 py-5 text-white bg-black sm:px-10 md:justify-between md:flex">
